...
class PluginManager:
    ...
    def load_plugins(self):
        ...
        plugin_paths = self.config.get("plugins", [])
    ...
    def process_metrics(self, metrics_request: monitoring_pb2.MetricsRequest) -> Optional[monitoring_pb2.MetricsRequest]:
        """
        Process metrics through all loaded plugins
